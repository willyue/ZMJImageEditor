...
- (void)viewDidLoad {
    ...
    if(orientation == UIInterfaceOrientationLandscapeRight || orientation == UIInterfaceOrientationLandscapeLeft) {
        self.colorPan.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.width-99, [UIScreen mainScreen].bounds.size.height, 50);
    }else{
...
- (void)configCustomComponent {
    ...
    if (curComponent & WBGImageEditorIndicatorComponent) { self.indicatorButton.hidden = YES; [valibleCompoment addObject:self.indicatorButton];
